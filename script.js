...
function displaydata(data){
    data.forEach(function(movie,i){
       ...
       somediv.classList.add('cinema');
        ...
        const storyline=document.createElement('h4')
        storyline.textContent="Plot: " + movie.storyline.slice(0,100)
        ...
        somediv.append(heading,image,year,storyline,actors,rating,button)
        library.appendChild(somediv)
...
function noti(e){
    ...
    if(e.target.textContent=="add to favourite💌"){
        ...
        e.target.textContent="remove from favourite💔"
        ++count;
    }
    else{
